...
export class MethodStatsService {
    ...
    static getMethodStats(filePath: string, name: string, className: string, isFunction = false): MethodStats {
        const fileStats: FileStats = FileStatsService.getFileStats(filePath);
